  ...
  return (
    ...
    >
      ...
      <line
        ...
        opacity="0.5"
      />
      <circle cx="80" cy="88" r="5" fill="#34D399" opacity="0.7" />
      <circle cx="600" cy="88" r="5" fill="#818CF8" opacity="0.7" />
      <circle cx="258" cy="88" r="3.5" fill="#34D399" opacity="0.85" />
      <circle cx="422" cy="88" r="3.5" fill="#818CF8" opacity="0.85" />
      ...
      {/* Tagline — inherits base-content so it stays light on dark */}
      <line
        x1="212"
        y1="232"
        x2="262"
